...
class DBProviderHelper {
  ...
  Future<dynamic> consultarCondicionEntrega(String fabricante) async {
    ...
    try {
      ...
      as montoMinimoFrecuencia, ce.MontoMinimoNoFrecuencia as montoMinimoNoFrecuencia, ce.DiasEntregaExtraRuta as diasEntregaExtraRuta FROM CondicionesEntrega ce LEFT JOIN Sucursales_Empresas se on ce.fabricante=se.empresa AND
