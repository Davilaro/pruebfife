          ...
          children: [
            ...
            if (widget.widgetIndicator != null &&
              ...
              Positioned(
                ...
                top: _containerHeight / 100 - _indicatorHeight,
                child: widget.widgetIndicator!,
              ),
          ],
        ),
...
// Define el pincel punteado
    ...
    // Dibujar una línea punteada manualmente
    List<Offset> dashPattern = <Offset>[];
    for (double i = 0; i < size.width; i += 20) {
      dashPattern.add(Offset(i, size.height));
    }
    canvas.drawPoints(PointMode.points, dashPattern, dashedPaint);

    // Recortar el lienzo al área del fondo
    canvas.clipPath(backgroundPath);
