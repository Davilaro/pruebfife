  ...
  Future<List<PedidoSugeridoModel>> obtenerPedidoSugerido() async {
    ...
    try {
      var sql = await db.rawQuery(
          '''SELECT CASE S.negocio WHEN 'AGCO' THEN 'NUTRESA' WHEN 'ADML' THEN 'MEALS' WHEN 'AANN' THEN 'ZENU' END Negocio, S.Codigo, P.Nombre, 
        ...
        ON P.Codigo = S.Codigo left join (select tmp.proveedor, tmp.material codigo, tmp.descuento from (
