...
class CustomersProspectionSuraViewModel extends GetxController {
  final customerProspectionSuraServices = CustomerProspectionsSuraUseCases();
  ...
  Future sendProspectionRequest() async {
    final response = await customerProspectionSuraServices.sendProspectionRequest(
