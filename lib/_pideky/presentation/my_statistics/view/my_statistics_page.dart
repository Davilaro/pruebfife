...
import 'package:emart/_pideky/presentation/my_statistics/view/widgets/acordion_empodio.dart';
...
class MyStatisticsPage extends StatefulWidget {
  MyStatisticsPage({Key? key}) : super(key: key);
...
class _MyStatisticsPageState extends State<MyStatisticsPage> {
  final MyStatisticsViewModel viewModel = Get.find();
