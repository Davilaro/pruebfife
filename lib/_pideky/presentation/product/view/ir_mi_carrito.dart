...
class _IrMiCarritoState extends State<IrMiCarrito> {
  ...
  validarPedidoMinimo(
      Size size, CartViewModel cartProvider, ProductViewModel productViewModel) {
  ...
  String cargarResultado(CartViewModel cartProvider) {
    double precio =
  ...
  String validarTextoInformativo(CartViewModel cartProvider) {
  ...
  String cargarResultadoPedido(CartViewModel cartProvider) {
    double precio = 0;
  ...
  bool cargarResultadoPedidoCondicion(CartViewModel cartProvider) {
    double valor = 0.0;
    print(
  ...
  Widget cargarWiguet(size, CartViewModel cartProvider, format) {
  ...
  Widget cargarValorPrecio(
      double? descuento, ProductViewModel productViewModel) {
    if (descuento != 0) {
