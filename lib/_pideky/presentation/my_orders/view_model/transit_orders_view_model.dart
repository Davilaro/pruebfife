...
class TransitOrdersViewModel extends GetxController
  ...
  static TransitOrdersViewModel get findOrInitialize {
    try {
      return Get.find<TransitOrdersViewModel>();
    } catch (e) {
      Get.put(TransitOrdersViewModel());
      return Get.find<TransitOrdersViewModel>();
    }
  }
}
